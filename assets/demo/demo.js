...
demo = {
  ...
  initDashboardPageCharts: function () {
    ...
    var chart_data = [123, 156, 239, 300, 505, 637, 0, 0, 0, 0, 0, 0];
    ...
    $('#1').click(function () {
      var chart_data = [30732, 39298, 59240, 72929, 86963, 96133, 0, 0, 0, 0, 0, 0];
      var data = myChartData.config.data;
      data.datasets[0].data = chart_data;
      data.labels = chart_labels;
      myChartData.update();
    ...
    $('#2').click(function () {
      var chart_data = [131, 78, 67, 73, 65, 39, 0, 0, 0, 0, 0, 0];
      var data = myChartData.config.data;
      data.datasets[0].data = chart_data;
      data.labels = chart_labels;
      myChartData.update();
    ...
    var chart_data1 = [80, 101, 138, 175, 287, 340, 0, 0, 0, 0, 0, 0];
    ...
    $('#1').click(function () {
      var chart_data1 = [25397, 0, 43836, 53445, 69559, 76821, 0, 0, 0, 0, 0, 0];
      var data = myChartData1.config.data;
      data.datasets[0].data = chart_data1;
      data.labels = chart_labels;
      myChartData1.update();
    ...
    $('#2').click(function () {
      var chart_data1 = [65, 45, 59, 24, 54, 24, 0, 0, 0, 0, 0, 0];
      var data = myChartData1.config.data;
      data.datasets[0].data = chart_data1;
      data.labels = chart_labels;
      myChartData1.update();
    ...
    var chart_data3 = [49, 56, 81, 94, 105,119, 0, 0, 0, 0, 0, 0];
    ...
    var chart_data4 = [0, 13, 17, 25, 20, 32, 0, 0, 0, 0, 0, 0];
    ...
    var chart_data5 = [3, 4, 5, 6, 8, 9, 0, 0, 0, 0, 0, 0];
    ...
    $('#2').click(function () {
      var chart_data5 = [2, 0, 1, 5, 5, 0, 0, 0, 0, 0, 0, 0];
      var data = myChartData5.config.data;
      data.datasets[0].data = chart_data5;
      data.labels = chart_labels;
      myChartData5.update();
